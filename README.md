...
### Обо мне
- Читаю много книг, в том числе по разработке. Из последних «Проектирование баз данных», «Python для exel», "Грокаем алгоритмы". Сейчас читаю "Asyncio и конкурентность" и "Микросервисы и API" 
- Также смотрю разные ролики на Ютубе и прохожу курсы. Из последних курсов "ООП на Python"
- С недавнего время начал решать задачи по CodeWars, NeetCode, LeetCode
- Готов работать удаленно
- 🌍Я живу в России
- ✉️ Вы можете связаться со мной по адресу [yagofarov.vadim@mail.ru](mailto:yagofarov.vadim@mail.ru)[](mailto:yagofarov.vadim@mail.ru)
- 🧠 Я изучаю Django, микросервисы 
- 🤝 Я открыт для сотрудничества в области бэкенда Python
...
<img src= "https://www.codewars.com/users/giru1/badges/micro" width= "200"/>
...
![LeetCode Stats](https://leetcode-stats.vercel.app/api?username=giru&theme=dark)
...
<table>
    <tr>
        ...
        <td>
            <a href="http://www.github.com/giru1">
...
<img src="https://github-readme-stats.vercel.app/api/top-langs/?username=giru1&langs_count=10&title_color=0891b2&text_color=ffffff&icon_color=0891b2&bg_color=1c1917&hide_border=true&locale=en&custom_title=Top%20%Languages" alt="Top Languages" style="width: 100%;"/>
